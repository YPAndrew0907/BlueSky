# Collector Data Inventory (20260216T002501Z)
...
## CSV
### `authors/{date}/._author_profiles_part_{n}.csv`
- Example file: `authors/2026-02-16/._author_profiles_part_000.csv`
- Columns (0): 
...
### `hourly/{date}/00/._http_stats.csv`
- Example file: `hourly/2026-02-16/00/._http_stats.csv`
- Columns (0): 

### `hourly/{date}/00/http_stats.csv`
...
### `hourly/{date}/00/parts/._feed_items_part_{n}.csv`
- Example file: `hourly/2026-02-16/00/parts/._feed_items_part_015.csv`
- Columns (0): 

### `hourly/{date}/00/parts/._post_labels_part_{n}.csv`
- Example file: `hourly/2026-02-16/00/parts/._post_labels_part_015.csv`
- Columns (0): 

### `hourly/{date}/00/parts/._post_metrics_part_{n}.csv`
- Example file: `hourly/2026-02-16/00/parts/._post_metrics_part_015.csv`
- Columns (0): 

### `hourly/{date}/00/parts/._posts_first_seen_part_{n}.csv`
- Example file: `hourly/2026-02-16/00/parts/._posts_first_seen_part_015.csv`
- Columns (0): 

### `hourly/{date}/00/parts/feed_items_part_{n}.csv`
...
### `hourly/{date}/00/parts/post_labels_part_{n}.csv`
...
### `hourly/{date}/00/parts/post_metrics_part_{n}.csv`
...
### `hourly/{date}/00/parts/posts_first_seen_part_{n}.csv`
...
### `hourly/{date}/09/._http_stats.csv`
- Example file: `hourly/2026-02-14/09/._http_stats.csv`
- Columns (0): 

### `hourly/{date}/09/http_stats.csv`
- Example file: `hourly/2026-02-14/09/http_stats.csv`
- Columns (7): `timestamp_utc`, `endpoint`, `status_code`, `latency_ms`, `attempt`, `error_type`, `feed_uri`
  - `timestamp_utc` = `2026-02-14T09:19:34Z`
  - `endpoint` = `com.atproto.server.createSession`
  - `status_code` = `200`
  - `latency_ms` = `605.888`
  - `attempt` = `0`
...
### `hourly/{date}/09/parts/._feed_items_part_{n}.csv`
- Example file: `hourly/2026-02-14/09/parts/._feed_items_part_006.csv`
- Columns (0): 

### `hourly/{date}/09/parts/._post_labels_part_{n}.csv`
- Example file: `hourly/2026-02-14/09/parts/._post_labels_part_007.csv`
- Columns (0): 

### `hourly/{date}/09/parts/._post_metrics_part_{n}.csv`
- Example file: `hourly/2026-02-14/09/parts/._post_metrics_part_007.csv`
- Columns (0): 

### `hourly/{date}/09/parts/._posts_first_seen_part_{n}.csv`
- Example file: `hourly/2026-02-14/09/parts/._posts_first_seen_part_007.csv`
- Columns (0): 

### `hourly/{date}/09/parts/feed_items_part_{n}.csv`
- Example file: `hourly/2026-02-14/09/parts/feed_items_part_003.csv`
- Columns (14): `run_id`, `snapshot_hour_utc`, `captured_at_utc`, `viewer_mode`, `vantage_id`, `feed_uri`, `bucket`, `rank`, `post_uri`, `post_cid`, `author_did`, `author_handle`, `reason_type`, `reason_actor_did`
  - `run_id` = `1d2b206b2fc54b5689d1f1d26c6310cd`
  - `snapshot_hour_utc` = `2026-02-14T09:00:00Z`
  - `captured_at_utc` = `2026-02-14T09:19:35Z`
  - `viewer_mode` = `auth`
  - `vantage_id` = `auth`
  - `feed_uri` = `at://did:plc:2hwwem55ce6djnk6bn62cstr/app.bsky.feed.generator/aaaotdzmoni2q`
  - `bucket` = `suggested`
  - `rank` = `1`
  - `post_uri` = `at://did:plc:2hwwem55ce6djnk6bn62cstr/app.bsky.feed.post/3m4jatdxays2e`
  - `post_cid` = `bafyreicw4wnhf6xfvzevhgrcmw4gyn4juo3fx3y63dgdjqfr3okm73jxcm`
  - `author_did` = `did:plc:2hwwem55ce6djnk6bn62cstr`
  - `author_handle` = `francesmeh.reviews`
  - `reason_type` = ``
  - `reason_actor_did` = ``

### `hourly/{date}/09/parts/post_labels_part_{n}.csv`
- Example file: `hourly/2026-02-14/09/parts/post_labels_part_004.csv`
- Columns (12): `run_id`, `snapshot_hour_utc`, `captured_at_utc`, `viewer_mode`, `vantage_id`, `post_uri`, `post_cid`, `label_src`, `label_val`, `label_neg`, `label_uri`, `label_cts`
  - `run_id` = `1d2b206b2fc54b5689d1f1d26c6310cd`
  - `snapshot_hour_utc` = `2026-02-14T09:00:00Z`
  - `captured_at_utc` = `2026-02-14T09:19:38Z`
  - `viewer_mode` = `auth`
  - `vantage_id` = `auth`
  - `post_uri` = `at://did:plc:xsbbtiasdmu6bmie2lhfcgpp/app.bsky.feed.post/3mesbde3vyk2p`
  - `post_cid` = `bafyreif56ve6jtcttwkxk2ppvhg5xertplrmsggkavplvq35ca4z2hou2a`
  - `label_src` = `did:plc:xsbbtiasdmu6bmie2lhfcgpp`
  - `label_val` = `porn`
  - `label_neg` = ``
  - `label_uri` = `at://did:plc:xsbbtiasdmu6bmie2lhfcgpp/app.bsky.feed.post/3mesbde3vyk2p`
  - `label_cts` = `2026-02-14T05:16:23.167Z`

### `hourly/{date}/09/parts/post_metrics_part_{n}.csv`
- Example file: `hourly/2026-02-14/09/parts/post_metrics_part_003.csv`
- Columns (10): `run_id`, `snapshot_hour_utc`, `captured_at_utc`, `viewer_mode`, `vantage_id`, `post_uri`, `like_count`, `repost_count`, `reply_count`, `quote_count`
  - `run_id` = `1d2b206b2fc54b5689d1f1d26c6310cd`
  - `snapshot_hour_utc` = `2026-02-14T09:00:00Z`
  - `captured_at_utc` = `2026-02-14T09:19:35Z`
...
### `hourly/{date}/09/parts/posts_first_seen_part_{n}.csv`
- Example file: `hourly/2026-02-14/09/parts/posts_first_seen_part_002.csv`
- Columns (14): `run_id`, `snapshot_hour_utc`, `captured_at_utc`, `viewer_mode`, `vantage_id`, `feed_uri`, `bucket`, `post_uri`, `post_cid`, `author_did`, `author_handle`, `record_created_at`, `indexed_at`, `text`
  - `run_id` = `1d2b206b2fc54b5689d1f1d26c6310cd`
  - `snapshot_hour_utc` = `2026-02-14T09:00:00Z`
  - `captured_at_utc` = `2026-02-14T09:19:35Z`
  ...
  - `author_did` = `did:plc:2hwwem55ce6djnk6bn62cstr`
  - `author_handle` = `francesmeh.reviews`
  - `record_created_at` = `2025-10-31T19:51:55.478Z`
  - `indexed_at` = `2025-10-31T19:52:00.364Z`
  - `text` = `📽️ Film Feed Tips ✍️

Welcome to Bluesky's premiere community for film lovers! 

This is the place to find filmsky posts, movie news & reviews, trailers, and...`

### `hourly/{date}/16/._http_stats.csv`
- Example file: `hourly/2026-02-15/16/._http_stats.csv`
- Columns (0): 

### `hourly/{date}/16/http_stats.csv`
- Example file: `hourly/2026-02-15/16/http_stats.csv`
- Columns (7): `timestamp_utc`, `endpoint`, `status_code`, `latency_ms`, `attempt`, `error_type`, `feed_uri`
  - `timestamp_utc` = `2026-02-15T16:24:57Z`
  - `endpoint` = `com.atproto.server.createSession`
  - `status_code` = `200`
  - `latency_ms` = `643.631`
  - `attempt` = `0`
...
### `hourly/{date}/16/parts/._feed_items_part_{n}.csv`
- Example file: `hourly/2026-02-15/16/parts/._feed_items_part_015.csv`
- Columns (0): 

### `hourly/{date}/16/parts/._post_labels_part_{n}.csv`
- Example file: `hourly/2026-02-15/16/parts/._post_labels_part_015.csv`
- Columns (0): 

### `hourly/{date}/16/parts/._post_metrics_part_{n}.csv`
- Example file: `hourly/2026-02-15/16/parts/._post_metrics_part_015.csv`
- Columns (0): 

### `hourly/{date}/16/parts/._posts_first_seen_part_{n}.csv`
- Example file: `hourly/2026-02-15/16/parts/._posts_first_seen_part_015.csv`
- Columns (0): 

### `hourly/{date}/16/parts/feed_items_part_{n}.csv`
- Example file: `hourly/2026-02-15/16/parts/feed_items_part_015.csv`
- Columns (14): `run_id`, `snapshot_hour_utc`, `captured_at_utc`, `viewer_mode`, `vantage_id`, `feed_uri`, `bucket`, `rank`, `post_uri`, `post_cid`, `author_did`, `author_handle`, `reason_type`, `reason_actor_did`
  - `run_id` = `e544e2ede2cb492585cb4d5d2c6f342c`
  - `snapshot_hour_utc` = `2026-02-15T16:00:00Z`
  - `captured_at_utc` = `2026-02-15T16:24:58Z`
  - `viewer_mode` = `auth`
  - `vantage_id` = `auth_enUS`
  - `feed_uri` = `at://did:plc:4jb3re5tvklsvhuc3lkerj5q/app.bsky.feed.generator/aaak6p5s2f3cu`
  - `bucket` = `popular_by_likecount`
  - `rank` = `1`
  - `post_uri` = `at://did:plc:yjnanyxp7ba2g6uhbzr64x6j/app.bsky.feed.post/3mevwhnixnk2m`
  - `post_cid` = `bafyreickbvefpisnbjz6erawienqw3tincqslq27djg6cts6bprm7kf5re`
  - `author_did` = `did:plc:yjnanyxp7ba2g6uhbzr64x6j`
  - `author_handle` = `selenammoon.bsky.social`
  - `reason_type` = ``
  - `reason_actor_did` = ``

### `hourly/{date}/16/parts/post_labels_part_{n}.csv`
- Example file: `hourly/2026-02-15/16/parts/post_labels_part_004.csv`
- Columns (12): `run_id`, `snapshot_hour_utc`, `captured_at_utc`, `viewer_mode`, `vantage_id`, `post_uri`, `post_cid`, `label_src`, `label_val`, `label_neg`, `label_uri`, `label_cts`
  - `run_id` = `e544e2ede2cb492585cb4d5d2c6f342c`
  - `snapshot_hour_utc` = `2026-02-15T16:00:00Z`
  - `captured_at_utc` = `2026-02-15T16:24:58Z`
  - `viewer_mode` = `unauth`
  - `vantage_id` = `unauth_enUS`
  - `post_uri` = `at://did:plc:zgnbygpweonepy2l2wdr6xgb/app.bsky.feed.post/3mevl57nsf22s`
  - `post_cid` = `bafyreib5glnyj5s6cirvukuqwjxiszfpmcgqpwiqqptyw4jbzkxtr6ol5a`
  - `label_src` = `did:plc:ar7c4by46qjdydhdevvrndac`
  - `label_val` = `porn`
  - `label_neg` = ``
  - `label_uri` = `at://did:plc:zgnbygpweonepy2l2wdr6xgb/app.bsky.feed.post/3mevl57nsf22s`
  - `label_cts` = `2026-02-15T12:50:04.315Z`

### `hourly/{date}/16/parts/post_metrics_part_{n}.csv`
- Example file: `hourly/2026-02-15/16/parts/post_metrics_part_015.csv`
- Columns (10): `run_id`, `snapshot_hour_utc`, `captured_at_utc`, `viewer_mode`, `vantage_id`, `post_uri`, `like_count`, `repost_count`, `reply_count`, `quote_count`
  - `run_id` = `e544e2ede2cb492585cb4d5d2c6f342c`
  - `snapshot_hour_utc` = `2026-02-15T16:00:00Z`
  - `captured_at_utc` = `2026-02-15T16:24:58Z`
...
### `hourly/{date}/16/parts/posts_first_seen_part_{n}.csv`
- Example file: `hourly/2026-02-15/16/parts/posts_first_seen_part_004.csv`
- Columns (14): `run_id`, `snapshot_hour_utc`, `captured_at_utc`, `viewer_mode`, `vantage_id`, `feed_uri`, `bucket`, `post_uri`, `post_cid`, `author_did`, `author_handle`, `record_created_at`, `indexed_at`, `text`
  - `run_id` = `e544e2ede2cb492585cb4d5d2c6f342c`
  - `snapshot_hour_utc` = `2026-02-15T16:00:00Z`
  - `captured_at_utc` = `2026-02-15T16:24:58Z`
  - `viewer_mode` = `unauth`
  - `vantage_id` = `unauth_enUS`
  - `feed_uri` = `at://did:plc:3sn6bogankaicebzdb7liro3/app.bsky.feed.generator/aaaclmwsj24p6`
  - `bucket` = `popular_by_likecount`
  - `post_uri` = `at://did:plc:hqzof2iaqbf36tyfmxlnytzf/app.bsky.feed.post/3mevvz5l5zo23`
  - `post_cid` = `bafyreihv37l3i2oztcp763zpylnaisxoxigdruhxffsaxaazbzwuxmrs4a`
  - `author_did` = `did:plc:hqzof2iaqbf36tyfmxlnytzf`
  - `author_handle` = `mgnews.bsky.social`
  - `record_created_at` = `2026-02-15T16:04:28.333427Z`
  - `indexed_at` = `2026-02-15T16:04:28.848Z`
  - `text` = `Managing chronic pain requires many tools. What strategies work best for you? #ChronicIllness`

### `hourly/{date}/23/._http_stats.csv`
- Example file: `hourly/2026-02-14/23/._http_stats.csv`
- Columns (0): 

### `hourly/{date}/23/http_stats.csv`
- Example file: `hourly/2026-02-14/23/http_stats.csv`
- Columns (7): `timestamp_utc`, `endpoint`, `status_code`, `latency_ms`, `attempt`, `error_type`, `feed_uri`
  - `timestamp_utc` = `2026-02-14T23:12:44Z`
  - `endpoint` = `com.atproto.server.createSession`
  - `status_code` = `200`
  - `latency_ms` = `710.66`
  - `attempt` = `0`
...
### `hourly/{date}/23/parts/._feed_items_part_{n}.csv`
- Example file: `hourly/2026-02-14/23/parts/._feed_items_part_014.csv`
- Columns (0): 

### `hourly/{date}/23/parts/._post_labels_part_{n}.csv`
- Example file: `hourly/2026-02-14/23/parts/._post_labels_part_014.csv`
- Columns (0): 

### `hourly/{date}/23/parts/._post_metrics_part_{n}.csv`
- Example file: `hourly/2026-02-14/23/parts/._post_metrics_part_015.csv`
- Columns (0): 

### `hourly/{date}/23/parts/._posts_first_seen_part_{n}.csv`
- Example file: `hourly/2026-02-14/23/parts/._posts_first_seen_part_014.csv`
- Columns (0): 

### `hourly/{date}/23/parts/feed_items_part_{n}.csv`
- Example file: `hourly/2026-02-14/23/parts/feed_items_part_005.csv`
- Columns (14): `run_id`, `snapshot_hour_utc`, `captured_at_utc`, `viewer_mode`, `vantage_id`, `feed_uri`, `bucket`, `rank`, `post_uri`, `post_cid`, `author_did`, `author_handle`, `reason_type`, `reason_actor_did`
  - `run_id` = `5080d164496942ac92fec5fcb40066b3`
  - `snapshot_hour_utc` = `2026-02-14T23:00:00Z`
  - `captured_at_utc` = `2026-02-14T23:12:45Z`
  - `viewer_mode` = `auth`
  - `vantage_id` = `auth`
  - `feed_uri` = `at://did:plc:2kpe74s7z4tjnugwwc5cuura/app.bsky.feed.generator/entomology`
  - `bucket` = `popular_by_likecount`
  - `rank` = `1`
  - `post_uri` = `at://did:plc:i6y3jdklpvkjvynvsrnqfdoq/app.bsky.feed.post/3ljplnclwds2o`
  - `post_cid` = `bafyreidkw4gbzzmfsvunsajcslokly5tjfahmgdu3wky4zq3ah333qhot4`
  - `author_did` = `did:plc:i6y3jdklpvkjvynvsrnqfdoq`
  - `author_handle` = `graze.social`
  - `reason_type` = ``
  - `reason_actor_did` = ``

### `hourly/{date}/23/parts/post_labels_part_{n}.csv`
- Example file: `hourly/2026-02-14/23/parts/post_labels_part_011.csv`
- Columns (12): `run_id`, `snapshot_hour_utc`, `captured_at_utc`, `viewer_mode`, `vantage_id`, `post_uri`, `post_cid`, `label_src`, `label_val`, `label_neg`, `label_uri`, `label_cts`
  - `run_id` = `5080d164496942ac92fec5fcb40066b3`
  - `snapshot_hour_utc` = `2026-02-14T23:00:00Z`
  - `captured_at_utc` = `2026-02-14T23:12:51Z`
  - `viewer_mode` = `unauth`
  - `vantage_id` = `unauth`
  - `post_uri` = `at://did:plc:vg3o7etl7cmkdpn75vhbugeb/app.bsky.feed.post/3meu47u5ufc22`
  - `post_cid` = `bafyreickywpqi3bu2h6b2jbtbqknh4ngwn46fg3w7uia2yxncwuolix3xm`
  - `label_src` = `did:plc:vg3o7etl7cmkdpn75vhbugeb`
  - `label_val` = `porn`
  - `label_neg` = ``
  - `label_uri` = `at://did:plc:vg3o7etl7cmkdpn75vhbugeb/app.bsky.feed.post/3meu47u5ufc22`
  - `label_cts` = `2026-02-14T22:50:16.535Z`

### `hourly/{date}/23/parts/post_metrics_part_{n}.csv`
- Example file: `hourly/2026-02-14/23/parts/post_metrics_part_005.csv`
- Columns (10): `run_id`, `snapshot_hour_utc`, `captured_at_utc`, `viewer_mode`, `vantage_id`, `post_uri`, `like_count`, `repost_count`, `reply_count`, `quote_count`
  - `run_id` = `5080d164496942ac92fec5fcb40066b3`
  - `snapshot_hour_utc` = `2026-02-14T23:00:00Z`
  - `captured_at_utc` = `2026-02-14T23:12:45Z`
...
### `hourly/{date}/23/parts/posts_first_seen_part_{n}.csv`
- Example file: `hourly/2026-02-14/23/parts/posts_first_seen_part_012.csv`
- Columns (14): `run_id`, `snapshot_hour_utc`, `captured_at_utc`, `viewer_mode`, `vantage_id`, `feed_uri`, `bucket`, `post_uri`, `post_cid`, `author_did`, `author_handle`, `record_created_at`, `indexed_at`, `text`
  - `run_id` = `5080d164496942ac92fec5fcb40066b3`
  - `snapshot_hour_utc` = `2026-02-14T23:00:00Z`
  - `captured_at_utc` = `2026-02-14T23:12:50Z`
  - `viewer_mode` = `auth`
  - `vantage_id` = `auth`
  - `feed_uri` = `at://did:plc:72x35sxqh5cougbqvhd7syaz/app.bsky.feed.generator/aaaim54by73py`
  - `bucket` = `popular_by_likecount`
  - `post_uri` = `at://did:plc:gmxsfx5ykgmfq2tjq5nynlhi/app.bsky.feed.post/3mesx33pmes2a`
  - `post_cid` = `bafyreibvpgtsczuc627tpvldxupi4opv27dcsxqhnsoubqc6tvbj3se26u`
  - `author_did` = `did:plc:gmxsfx5ykgmfq2tjq5nynlhi`
  - `author_handle` = `nyskin.bsky.social`
  - `record_created_at` = `2026-02-14T11:45:28.264Z`
  - `indexed_at` = `2026-02-14T11:45:28.553Z`
  - `text` = `GODIVA6000もしたけど彼氏が喜んでくれたんで無問題`

### `metadata/{date}/._feed_catalog.csv`
- Example file: `metadata/2026-02-15/._feed_catalog.csv`
- Columns (0): 

### `metadata/{date}/._starterpack_accounts.csv`
- Example file: `metadata/2026-02-15/._starterpack_accounts.csv`
- Columns (0): 

### `metadata/{date}/._starterpack_feeds.csv`
- Example file: `metadata/2026-02-15/._starterpack_feeds.csv`
- Columns (0): 

### `metadata/{date}/._suggested_accounts.csv`
- Example file: `metadata/2026-02-15/._suggested_accounts.csv`
- Columns (0): 

### `metadata/{date}/._suggested_feeds.csv`
- Example file: `metadata/2026-02-15/._suggested_feeds.csv`
- Columns (0): 

### `metadata/{date}/._suggested_follows_by_actor.csv`
- Example file: `metadata/2026-02-15/._suggested_follows_by_actor.csv`
- Columns (0): 
...
### `metadata/{date}/feed_generators_index/._http_stats.csv`
- Example file: `metadata/2026-02-16/feed_generators_index/._http_stats.csv`
- Columns (0): 
...
### `panel/._panel_v1.csv`
- Example file: `panel/._panel_v1.csv`
- Columns (0): 
...
### `panel/panel_versions/._panel_v1_2026-02-14.csv`
- Example file: `panel/panel_versions/._panel_v1_2026-02-14.csv`
- Columns (0): 

### `panel/panel_versions/._panel_v1_2026-02-15.csv`
- Example file: `panel/panel_versions/._panel_v1_2026-02-15.csv`
- Columns (0): 

### `panel/panel_versions/panel_v1_2026-02-14.csv`
- Example file: `panel/panel_versions/panel_v1_2026-02-14.csv`
- Columns (5): `feed_uri`, `bucket`, `unauth_skip`, `built_at_utc`, `panel_version_id`
  - `feed_uri` = `at://did:plc:3guzzweuqraryl3rdkimjamk/app.bsky.feed.generator/for-you`
  - `bucket` = `popular_by_likecount`
  - `unauth_skip` = `0`
  - `built_at_utc` = `2026-02-14T23:09:58Z`
  - `panel_version_id` = `2026-02-14`

### `panel/panel_versions/panel_v1_2026-02-15.csv`
...
### `wide/{date}/._http_stats.csv`
- Example file: `wide/2026-02-16/._http_stats.csv`
- Columns (0): 
...
### `wide/{date}/parts/._feed_items_part_{n}.csv`
- Example file: `wide/2026-02-16/parts/._feed_items_part_014.csv`
- Columns (0): 

### `wide/{date}/parts/._post_labels_part_{n}.csv`
- Example file: `wide/2026-02-16/parts/._post_labels_part_015.csv`
- Columns (0): 

### `wide/{date}/parts/._post_metrics_part_{n}.csv`
- Example file: `wide/2026-02-16/parts/._post_metrics_part_014.csv`
- Columns (0): 

### `wide/{date}/parts/._posts_first_seen_part_{n}.csv`
- Example file: `wide/2026-02-16/parts/._posts_first_seen_part_014.csv`
- Columns (0): 
...
## JSONL
### `metadata/{date}/discovery_sources/._onboarding_suggested_starterpacks.jsonl`
- Example file: `metadata/2026-02-15/discovery_sources/._onboarding_suggested_starterpacks.jsonl`
- Top-level keys (0): 

### `metadata/{date}/discovery_sources/._popular_feed_generators.jsonl`
- Example file: `metadata/2026-02-15/discovery_sources/._popular_feed_generators.jsonl`
- Top-level keys (0): 

### `metadata/{date}/discovery_sources/._suggested_accounts.jsonl`
- Example file: `metadata/2026-02-15/discovery_sources/._suggested_accounts.jsonl`
- Top-level keys (0): 

### `metadata/{date}/discovery_sources/._suggested_feeds.jsonl`
- Example file: `metadata/2026-02-15/discovery_sources/._suggested_feeds.jsonl`
- Top-level keys (0): 

### `metadata/{date}/discovery_sources/._suggested_follows_by_actor.jsonl`
- Example file: `metadata/2026-02-15/discovery_sources/._suggested_follows_by_actor.jsonl`
- Top-level keys (0): 
...
### `metadata/{date}/feed_generators_index/parts/._feed_generators_part_{n}.jsonl`
- Example file: `metadata/2026-02-16/feed_generators_index/parts/._feed_generators_part_000000.jsonl`
- Top-level keys (0): 
...
## SQLITE
### `control/._control_state.backup.db`
- Example file: `control/._control_state.backup.db`
- Tables (1):
  - `_error` columns (0): 

### `control/._control_state.db`
- Example file: `control/._control_state.db`
- Tables (1):
  - `_error` columns (0): 
...
### `hourly/{date}/00/._snapshot_status.sqlite`
- Example file: `hourly/2026-02-16/00/._snapshot_status.sqlite`
- Tables (1):
  - `_error` columns (0): 

### `hourly/{date}/00/snapshot_status.sqlite`
...
### `hourly/{date}/09/._snapshot_status.backup.sqlite`
- Example file: `hourly/2026-02-14/09/._snapshot_status.backup.sqlite`
- Tables (1):
  - `_error` columns (0): 

### `hourly/{date}/09/._snapshot_status.sqlite`
- Example file: `hourly/2026-02-14/09/._snapshot_status.sqlite`
- Tables (1):
  - `_error` columns (0): 

### `hourly/{date}/09/snapshot_status.backup.sqlite`
- Example file: `hourly/2026-02-14/09/snapshot_status.backup.sqlite`
- Tables (1):
  - `feed_tasks` columns (8): `feed_uri`, `viewer_mode`, `status`, `attempts`, `last_error`, `updated_at_utc`, `started_at_utc`, `finished_at_utc`
    - `feed_uri` = `at://did:plc:3guzzweuqraryl3rdkimjamk/app.bsky.feed.generator/for-you`
    - `viewer_mode` = `unauth`
    ...
    - `updated_at_utc` = `2026-02-14T09:19:36Z`
    - `started_at_utc` = `2026-02-14T09:19:35Z`
    - `finished_at_utc` = `2026-02-14T09:19:36Z`

### `hourly/{date}/09/snapshot_status.sqlite`
- Example file: `hourly/2026-02-14/09/snapshot_status.sqlite`
- Tables (1):
  - `feed_tasks` columns (8): `feed_uri`, `viewer_mode`, `status`, `attempts`, `last_error`, `updated_at_utc`, `started_at_utc`, `finished_at_utc`
    - `feed_uri` = `at://did:plc:3guzzweuqraryl3rdkimjamk/app.bsky.feed.generator/for-you`
    - `viewer_mode` = `unauth`
...
### `hourly/{date}/16/._snapshot_status.sqlite`
- Example file: `hourly/2026-02-15/16/._snapshot_status.sqlite`
- Tables (1):
  - `_error` columns (0): 

### `hourly/{date}/16/snapshot_status.sqlite`
- Example file: `hourly/2026-02-15/16/snapshot_status.sqlite`
- Tables (1):
  - `feed_tasks` columns (8): `feed_uri`, `viewer_mode`, `status`, `attempts`, `last_error`, `updated_at_utc`, `started_at_utc`, `finished_at_utc`
    - `feed_uri` = `at://did:plc:3guzzweuqraryl3rdkimjamk/app.bsky.feed.generator/for-you`
    - `viewer_mode` = `unauth`
    ...
    - `attempts` = `2`
    - `last_error` = `HttpError('InvalidRequest: InvalidRequest')`
    - `updated_at_utc` = `2026-02-15T16:39:04Z`
    - `started_at_utc` = `2026-02-15T16:38:53Z`
    - `finished_at_utc` = `2026-02-15T16:39:04Z`

### `hourly/{date}/23/._snapshot_status.backup.sqlite`
- Example file: `hourly/2026-02-14/23/._snapshot_status.backup.sqlite`
- Tables (1):
  - `_error` columns (0): 

### `hourly/{date}/23/._snapshot_status.sqlite`
- Example file: `hourly/2026-02-14/23/._snapshot_status.sqlite`
- Tables (1):
  - `_error` columns (0): 

### `hourly/{date}/23/snapshot_status.backup.sqlite`
...
### `hourly/{date}/23/snapshot_status.sqlite`
- Example file: `hourly/2026-02-14/23/snapshot_status.sqlite`
- Tables (1):
  - `feed_tasks` columns (8): `feed_uri`, `viewer_mode`, `status`, `attempts`, `last_error`, `updated_at_utc`, `started_at_utc`, `finished_at_utc`
    - `feed_uri` = `at://did:plc:3guzzweuqraryl3rdkimjamk/app.bsky.feed.generator/for-you`
    - `viewer_mode` = `unauth`
